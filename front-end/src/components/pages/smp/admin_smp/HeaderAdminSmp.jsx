...
const HeaderAdminSmp = ({ title }) => {
    ...
    const getUserAdmin = async () => {
        try {
            const response = await axios.get("http://localhost:3001/api/admin-smp/get-admin-smp", {
                headers: {
                        ...
                        <ul>
                            <li>
                                <div style={{ gap: "10px", display: "flex", alignItems: "center" }}>
                                    <><Icon.Gear /></>
                                    <a href="/admin-smp/profile-admin-smp" style={{ color: 'inherit', textDecoration: "none" }}> Profile Setting</a>

                                </div>
                            </li>
                            <li>
                                <div onClick={handleLogout} style={{ gap: "10px", display: "flex", alignItems: "center" , cursor: "pointer" }}>
                                    <Icon.BoxArrowRight />
                                    <>Logout</>
                                </div>
                            </li>

  ...
  return (
    <div className="parallax-wrapper">
      ...
      <div className="content-overlay">
        <h2 className="title">Kata Sambutan Kepala Sekolah SMP</h2>
        <div className="profile-container">
          {data.foto_kepala && (
            <Image src={data.foto_kepala} fluid rounded className="kepsek-img" alt="Gambar Kepala Sekolah SMP"/>
          )}
...
export default DetailKataSambutanSmp;

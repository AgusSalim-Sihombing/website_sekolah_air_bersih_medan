...
const KataSambutanSma = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (idSambutan) {
        // Update
        await axios.put(`${API_URL}/admin-sma/kata-sambutan-sma/${idSambutan}`, formData, {
          headers: {
        ...
        // Tambah baru
        await axios.post(`${API_URL}/admin-sma/kata-sambutan-sma`, formData, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "multipart/form-data",
          },
...
export default KataSambutanSma;

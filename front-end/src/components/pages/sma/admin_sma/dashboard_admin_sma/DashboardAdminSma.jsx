...
const DashboardAdminSma = () => {
    ...
    const fetchSchedules = async () => {
        try {
            const res = await axios.get(`${API_URL}/admin-sma/schedule-admin-sma`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editMode && editId) {
                // Mode edit
                await axios.put(`${API_URL}/admin-sma/schedule-admin-sma/${editId}`, formData, {
                    headers: { Authorization: `Bearer ${token}` }
                });
            } else {
                // Mode create
                await axios.post(`${API_URL}/admin-sma/schedule-admin-sma`, formData, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                window.confirm("Jad")
            }
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.delete(`${API_URL}/admin-sma/schedule-admin-sma/${id}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            fetchSchedules();
        } catch (error) {
...
export default DashboardAdminSma;

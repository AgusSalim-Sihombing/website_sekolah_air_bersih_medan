...
const HeaderAdminSmk = ({ title }) => {
    ...
    const getUserAdmin = async () => {
        try {
            const response = await axios.get("http://localhost:3001/api/admin-smk/get-admin-smk", {
                headers: {
                        ...
                        <ul>
                            <li>
                                <div style={{ gap: "10px", display: "flex", alignItems: "center" }}>
                                    <><Icon.Gear /></>
                                    <a href="/admin-smk/profile-admin-smk" style={{ color: 'inherit', textDecoration: "none" }}> Profile Setting</a>

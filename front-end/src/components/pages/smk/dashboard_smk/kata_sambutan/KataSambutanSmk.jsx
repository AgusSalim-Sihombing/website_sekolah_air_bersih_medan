...
const KataSambutanSmk = () => {
  ...
  const fetchSambutan = async () => {
    try {
      const res = await axios.get(`${API_URL}/smk/get-kata-sambutan-smk`);
    ...
    <Container className="py-5">
      <Row className="align-items-center">
        <Col md={4} className="text-center mb-4 mb-md-0">
          ...
          <p className="text-muted">Kepala Sekolah SMK</p>
        </Col>
        <Col md={8}>
          <h3 className="mb-3">Kata Sambutan Kepala Sekolah SMK</h3>
          <div
          ...
          ></div>
          <Button variant="outline-primary" className="mt-3" href="/smk/kata-sambutan">
            Baca Selengkapnya &gt;
          </Button>
        </Col>
      </Row>
...
export default KataSambutanSmk;

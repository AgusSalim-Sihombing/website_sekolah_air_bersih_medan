            ...
            <Container>
                ...
                <Row>
                    <Col className="text-center">
                        <p className="mb-0">&copy; {new Date().getFullYear()} SMK Advent Air Bersih. All rights reserved.</p>
                    </Col>
                </Row>
            </Container>
        </footer>
